<?php $secondary_local_tasks = false;?>
  ...
  <div class="brandKv">
  	<div class="container kvBg" style="width:100%; max-width:1920px;">
      	<div class="container">
          	<div class="col-xs-12">
                  <div class="innerDiv">
                  	<img src="<?php print path_to_theme();?>/images/brand/kv_m.png" class="mobileShow" width="100%">
                      <img src="<?php print path_to_theme();?>/images/brand/logo.png" class="abs bkLogo">
                      <img src="<?php print path_to_theme();?>/images/brand/bottle.png" class="abs bkBottle">
                  </div>
              </div>
          </div>
      </div>
              ...
              <div class="brandLine brandLine1">
                  <div class="innerDiv">
                      <div class=" col-md-5 col-md-offset-2 col-sm-7 col-xs-12 brandLineLeft brandLine1Left anmBlock">
                          <img src="<?php print path_to_theme();?>/images/brand/b_70.png" width="100%" class="needShowa" style="opacity:0;">
                      </div>
                      <div class=" col-md-4 col-sm-6 col-xs-12 brandLineRight brandLine1Right anmBlock">
                          <div class="brandLineRightContent needShowb" style="opacity:0;">
                              ...
                              <div class="brandBuyLink">
                                  立 即 购 买<a href="#"><img src="<?php print path_to_theme();?>/images/footIcon2.png" width="36"></a> <a href="#"><img src="<?php print path_to_theme();?>/images/footIcon3.png" width="36"></a>
                              </div>
                          </div>
                      </div>
                      <div class="clearfix"></div>
              ...
              <div class="brandLine brandLine2">
                  <div class="innerDiv">
                      <div class=" col-md-5 col-md-offset-2 col-sm-7 col-xs-12 brandLineLeft brandLine2Left anmBlock">
                          <img src="<?php print path_to_theme();?>/images/brand/b_20.png" width="100%" class="needShowa" style="opacity:0;">
                      </div>
              ...
              <div class="brandLine brandLine3">
                  <div class="innerDiv">
                      <div class=" col-md-5 col-md-offset-2 col-sm-7 col-xs-12 brandLineLeft brandLine3Left anmBlock">
                          <img src="<?php print path_to_theme();?>/images/brand/b_150.png" width="100%" class="needShowa" style="opacity:0;">
                      </div>
                      ...
                      <div class=" col-md-4 col-sm-6 col-xs-12 brandLineRight brandLine5Right anmBlock brandLineRightHasGreen">
                      	<div class="innerDiv">
                              <div class=" col-md-4 col-sm-6 col-xs-12 brandLineRightInner" style="padding:0;">
                                  <div class="brandLineRightContent needShowb" style="opacity:0; z-index:100;">
                                      <div class="innerDiv">
                                          <img src="<?php print path_to_theme();?>/images/brand/fw.png" width="100%">
                                      </div>
                                  </div>
                              </div>
                          </div>
                  ...
                  <div class="innerDiv">
                      <div class="col-md-8 col-md-offset-2 col-sm-12">
                          <div class="biTop anmBlock">
                              <div class="innerDiv">
                                  <img src="<?php print path_to_theme();?>/images/brand/infoTop.png" width="100%">
                      ...
                      <div class="col-md-8 col-md-offset-2 col-sm-12 biBottom">
                          <div class="bibLeft anmBlock2">
                              <div class="bibTop">
                                  <div class="innerDiv">
                                      <img src="<?php print path_to_theme();?>/images/brand/info1.png" width="100%">
                          ...
                          <div class="bibRight anmBlock">
                              <div class="bibTop">
                                  <div class="innerDiv">
                                      <img src="<?php print path_to_theme();?>/images/brand/info2.png" width="100%">
  ...
  <footer class="foot2">
      <div class="container">
          <div class="footQc"><img src="<?php print path_to_theme();?>/images/footQc.png">
              <div class="footQcTxt">关 注 轩 尼 诗 新 点 官 方 微 信</div>
              <div class="footLogo"><img src="<?php print path_to_theme();?>/images/footLogo.png" width="157"></div>
          </div>
          <div class="footSns"><a href="javascript:void(0);" class="fsBtn"><img src="<?php print path_to_theme();?>/images/footIcon1.png" width="36"></a> <a
                  href="javascript:void(0);" class="fsBtn"><img src="<?php print path_to_theme();?>/images/footIcon2.png" width="36"></a> <a
                  href="javascript:void(0);" class="fsBtn"><img src="<?php print path_to_theme();?>/images/footIcon3.png" width="36"></a></div>
          <div class="footLink"><a href="#">条款及条件</a><br class="mobileShow"><font class="pcShow"><img src="<?php print path_to_theme();?>/images/footPoint.png"></font><a href="#">隐私权政策</a><br class="mobileShow"><font class="pcShow"><img src="<?php print path_to_theme();?>/images/footPoint.png"></font><a href="#">请理性享用轩尼诗干邑</a><br class="mobileShow"><font class="pcShow"><img src="<?php print path_to_theme();?>/images/footPoint.png"></font><a href="#">访问轩尼诗全球官网</a>
          </div>
  ...
  <script src="<?php print path_to_theme();?>/js/jquery.touchSwipe.min.js"></script>
  <script src="<?php print path_to_theme();?>/js/html5lightbox/html5lightbox.js"></script>
  <script src="<?php print path_to_theme();?>/js/jquery.mCustomScrollbar.concat.min.js"></script>
  <script type="text/javascript" src="http://player.youku.com/jsapi"></script>
  <script src="<?php print path_to_theme();?>/js/bxslider/jquery.bxslider.min.js"></script>
